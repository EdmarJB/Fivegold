    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Sua senha foi salva com sucesso!"
                : message == ManageMessageId.SetTwoFactorSuccess ? "A autenticação de dois fatores foi salva com secesso!"
                ...
                : message == ManageMessageId.RemovePhoneSuccess ? "Seu numero de telefone foi removido!"
                : "";
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.Error ? "Ocorreu uym erro!"
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
            {
